...
const columnData = [
    { id: "id", numeric: true, disablePadding: true, label: "ID Evento" },
    ...
    { id: "system", numeric: false, disablePadding: false, label: "Sistema" },
    {
        id: "subsys",
        numeric: false,
        disablePadding: false,
    ...
    { id: "totalp", numeric: true, disablePadding: false, label: "Total Pot." },
    { id: "problem", numeric: false, disablePadding: false, label: "Problema" },
    {
        id: "severity",
        numeric: true,
        disablePadding: false,
    ...
    { id: "nodo", numeric: false, disablePadding: false, label: "Nodo" },
    {
        id: "cuadrante",
        numeric: false,
        disablePadding: false,
    ...
    { id: "georef", numeric: false, disablePadding: false, label: "Geo Ref." }
];
